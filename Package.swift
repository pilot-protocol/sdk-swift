...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "PilotC",
            url: "https://github.com/pilot-protocol/sdk-swift/releases/download/v1.13.6/Pilot.xcframework.zip",
            ...
            checksum: "2fa4e2e09afb480f6cb7015e322f45a798caf2d352335357592a5c5e37fdbcc7"
        ),
        .testTarget(
            name: "PilotTests",
            dependencies: ["Pilot"],
