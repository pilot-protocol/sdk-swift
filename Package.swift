...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "PilotC",
            url: "https://github.com/pilot-protocol/sdk-swift/releases/download/v1.13.5/Pilot.xcframework.zip",
            ...
            checksum: "07e31a2a1cceec2c0047d246f348375bd311cad125c064e0aeb76ed12c08fc7b"
        ),
        .testTarget(
            name: "PilotTests",
            dependencies: ["Pilot"],
