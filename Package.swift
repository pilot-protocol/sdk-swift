...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "PilotC",
            url: "https://github.com/pilot-protocol/sdk-swift/releases/download/v1.13.4/Pilot.xcframework.zip",
            ...
            checksum: "a9508972d6897a234a3c2b13081630b74a6f27d3e6cbbbdc9c97dbcdd79248c2"
        ),
        .testTarget(
            name: "PilotTests",
            dependencies: ["Pilot"],
