...
Thanks for your interest in contributing to `sdk-swift` — Pilot Protocol Swift SDK — Package.swift bindings for iOS/macOS via libpilot.xcframework.

## Quick start

```bash
git clone https://github.com/pilot-protocol/sdk-swift.git
cd sdk-swift
swift test
```
